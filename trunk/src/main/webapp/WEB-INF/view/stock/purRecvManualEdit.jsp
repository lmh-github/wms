...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		...
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/stock/purchaseRecv!inputGoodsNew.action?id=${receive.id}" target="dialog" rel="dlg_purchaseRecvInputGoodsNew" mask="true" width="800" height="600"><span>添加收货商品</span></a></li>
			</ul>
		</div>
		<div class="tabs">
