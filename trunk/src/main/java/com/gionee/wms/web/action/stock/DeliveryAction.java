...
//	}
//
//	public void prepareListGoods() throws Exception {
//		Validate.notNull(id);
//		// 初始化Model对象
//		delivery = deliveryService.getDelivery(id);
//		goodsList = deliveryService.getDeliveryGoodsList(id);
//	}
//
//	public String listGoods2() throws Exception {
//		return listGoods();
//	}
//
//	public void prepareListGoods2() throws Exception {
//		Long orderId = Long.parseLong(ActionUtils.getRequest().getParameter("orderId"));
//		Validate.notNull(orderId);
//		// 初始化Model对象
//		delivery = deliveryService.getDeliveryByOrderId(orderId);
//		goodsList = deliveryService.getDeliveryGoodsListByOrderId(orderId);
//	}
//
//	/**
//	 * 进入发货个体编辑页面
//	 */
//	public String inputIndiv() throws Exception {
...
//			// indivList =
//			// indivService.getDeliveryIndivs(goods.getDeliveryCode(),
//			// goods.getSkuId());
//			indivList = indivService.getIndivFlowsByFlowItemId(IndivFlowType.OUT_SALES.getCode(), id);
//		}
//		return "input_indiv";
//	}
//
//	public void prepareInputIndiv() throws Exception {
//		Validate.notNull(id);
//		// 初始化Model对象
//		goods = deliveryService.getDeliveryGoods(id);
//	}
//
//	/**
//	 * 更新发货个体
//	 */
//	public String updateDeliveryIndivs() throws Exception {
//		if (!accountService.isPermitted(PermissionConstants.SALES_OUT_INDIV_EDIT)) {
//			throw new AccessException();
//		}
...
//				deliveryService.updateDeliveryIndivs(goods, indivList);
...
//	}
//
//	public void prepareUpdateDeliveryIndivs() throws Exception {
//		Validate.notNull(id);
//		goods = deliveryService.getDeliveryGoods(id);
//	}
...
//		setForwardUrl(forwardUrl + "?warehouseId="+warehouseId+"&batchCode=" + batchCode);
...
//			orderIds = orderIds + delivery.getOriginalId() + ",";
//		}
		...
		try {
			...
			if(null==order) {
				...
				try {
					...
					salesOrderLog
							.setOrderStatus(WmsConstants.OrderStatus.SHIPPING
									.getCode());
					salesOrderLog.setOpUser(ActionUtils.getLoginName() == null
