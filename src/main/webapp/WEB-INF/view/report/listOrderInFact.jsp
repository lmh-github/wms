    ...
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/report/listOrderInFact!listPurRecvSummary.action" method="post">
        ...
        <div class="searchBar">
            <ul class="searchContent">
                ...
                <li>
                    <label>签收开始时间：</label>
                    <input type="text" name="qianShouTimeBegin" class="date" size="15" dateFmt="yyyy-MM-dd HH:mm:ss" value="<fmt:formatDate value="${qianShouTimeBegin }" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
                </li>
                <li>
                    <label>签收截止时间：</label>
                    <input type="text" name="qianShouTimeEnd" class="date" size="15" dateFmt="yyyy-MM-dd HH:mm:ss" value="<fmt:formatDate value="${qianShouTimeEnd }" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
                </li>
            </ul>
            <div class="subBar">
                <ul>
                    ...
                    <li>
                        <div class="buttonActive">
                            <a href="${ctx}/report/listOrderInFact!listPurRecvSummary.action?exports=1" target="dwzExport" targettype="navTab"><span>导出excel</span></a>
                        </div>
                    </li>
