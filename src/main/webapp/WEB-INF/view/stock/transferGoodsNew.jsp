...
<form id="theForm" action="${ctx}/stock/transfer!addGoods.action?callbackType=closeCurrent" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, transferNewAjaxDone)">
...
function transferNewAjaxDone(json){
    ...
    if (json.statusCode == DWZ.statusCode.ok){
    	...
    	$.pdialog.reload('${ctx}/stock/transfer!inputManual.action?transfer.transferId=${transferId}',{dialogId:'dlg_transfer_manual'});
    }
}
function doSubmit(){
	$('#theForm').submit();
