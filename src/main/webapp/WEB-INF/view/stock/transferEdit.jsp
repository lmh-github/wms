        ...
        <div class="pageFormContent" layoutH="97">
            <fieldset>
                ...
                <dl>
                    <dt>收货地址：</dt>
                    <dd>
                        <input name="transfer.transferTo" class="required" type="text" maxlength="40" value="${transfer.transferTo }" ${editEnabled?"":"readonly='readonly'"} />
                    </dd>
                </dl>
                <dl>
                    <dt>收货人：</dt>
                ...
                <dl>
                    <dt>PO：</dt>
                    <dd>
                        <input name="transfer.po" type="text" maxlength="20" size="20" value="${transfer.po }" ${editEnabled?"":"readonly='readonly'"}/>
                    </dd>
                </dl>
                <dl>
                    <dt>物流公司：</dt>
                    <dd>
                        <input name="transfer.logisticName" type="text" maxlength="20" size="20" value="${transfer.logisticName }" ${editEnabled?"":"readonly='readonly'"}/>
                    </dd>
                </dl>
                <dl class="nowrap">
                    <dt>售达方：</dt>
