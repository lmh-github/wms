    ...
    <div class="pageFormContent" layoutH="97">
        <fieldset>
            ...
            <dl>
                <dt>收货人：</dt>
                <dd>
                    <input name="transfer.consignee" type="text" maxlength="20" size="20" value="${transfer.consignee }"/>
                </dd>
            </dl>
            <dl>
                <dt>联系方式：</dt>
                <dd><input name="transfer.contact" type="text" maxlength="20" size="20" value="${transfer.contact }"/>
                </dd>
            </dl>
            <dl>
                <dt>调货类型：</dt>
                <dd>
                    <select name="transfer.transType" style="width: 152px;">
        ...
        <s:if test="transfer.status==1 || (transfer.status==3 && goodsList.size()==0)">
            <div class="panelBar">
                <ul class="toolBar">
                    <li>
                        <a class="add" href="${ctx}/stock/transferSf!inputGoodsNew.action?transferId=${transfer.transferId}" target="dialog" rel="dlg_transfer_goodsnew" mask="true" width="800" height="600"><span>添加调拨商品</span></a>
                    </li>
                </ul>
            </div>
        </s:if>
