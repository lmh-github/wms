    ...
    <div class="pageHeader">
        <div class="pageFormContent nowrap">
            <fieldset>
                ...
                <dl>
                    <dt>调拨仓：</dt>
                    <dd><s:property value="warehouse.warehouseName"/></dd>
                </dl>
            </fieldset>
            <dl>
                <dt>调货单:</dt>
                <dd>
                    <input name="transferId" type="text" class="textInput digits required" value="${transferId }" readonly="readonly"/>
                </dd>
            </dl>
            <dl id="scanIndiv">
                <dt>扫描个体编码 / SKU：</dt>
                <dd>
                    <input id="indivCode2" name="indivCode" type="text" class="textInput" onKeydown="doKeydown(event, this)"/><span id="scanCode" style="color: red; font-size: 12pt; float: left;"></span>
                </dd>
            </dl>
            ...
            <div id="scanShipping" style="display: none;">
                <dl>
                    <dt>扫描物流运单：</dt>
                    <dd>
                        <input id="logisticNo" name="logisticNo" type="text" class="required textInput" maxlength="20" onkeydown="toSubmit(event, this)" />
                    </dd>
                </dl>
            </div>
