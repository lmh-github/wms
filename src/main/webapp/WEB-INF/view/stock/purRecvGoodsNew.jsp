        ...
        <div class="pageFormContent">
            <fieldset>
                ...
                <dl class="nowrap">
                    <dt>商品状态：</dt>
                    <dd>
                        <label style="width: initial"><input type="radio" name="goods.waresStatus" style="vertical-align: sub" value="1" ${goods.waresStatus==null?"checked='checked'":(goods.waresStatus=='1'?"checked='checked'":"") }/>良品</label>
                        <label style="width: initial"><input type="radio" name="goods.waresStatus" style="vertical-align: sub" value="0" ${goods.waresStatus==null?"":(goods.waresStatus=='0'?"checked='checked'":"") }/>次品</label>
                    </dd>
                </dl>
            </fieldset>
            ...
            <div id="indivCodeEdit" style="display:${goods.indivEnabled==1?"block":"none"};">
                ...
                <div class="tabs">
                    <div class="tabsContent" style="height: 250px;">
                        <div>
                            <textarea name="indivText" style="width: 300px;height: 240px;">${indivText}</textarea>
                        </div>
                    </div>
