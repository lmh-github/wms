        ...
        <fieldset>
            ...
            <ul>
                <li>
                    ...
                    <input id="transferId1" name="transferId" class="textInput" type="number" size="30" value="" maxlength="25" min="0">
                    <label id="scanTips" style="color: red;width: auto;"></label>
                </li>
            </ul>
        </fieldset>
    </div>
...
<script type="text/javascript">
    ...
    function scanDeliveryCode(value) {
        scanTips(value);
        $.ajax({
            url: "${ctx}/stock/transPrepareSf!readyPrepare.action",
            data: "transferId=" + value,
            success: function (data) {
                if (data.ok == true) {
                    navTab.reload("${ctx}/stock/transPrepareSf!list.action?transferId=" + data.result.transferId, navTab.getCurrentPanel());
                } else {
