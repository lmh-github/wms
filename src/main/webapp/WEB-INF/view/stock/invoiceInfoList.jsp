...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/stock/invoiceInfo.action" method="post">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="edit" href="${ctx}/stock/invoiceInfo!makeEInvoice.action?orderCode={sid_order}" target="ajaxTodo" title="确定要开发电子票吗？" mask="true"><span>开具电子发票</span></a></li>
            <li class="line">line</li>
            <li><a class="edit" href="${ctx}/stock/invoiceInfo!ch.action?orderCode={sid_order}" target="ajaxTodo" title="确定要冲红电子票吗？" mask="true"><span>冲红电子发票</span></a></li>
            <li class="line">line</li>
            <li><a class="edit" href="${ctx}/stock/invoiceInfo!downPDF.action?orderCode={sid_order}" target="ajaxTodo" title="确定要及时取票吗？" mask="true"><span>手工取票</span></a></li>
            <li class="line">line</li>
        </ul>
    </div>
    <table class="list" width="100%" layoutH="120">
        ...
        <tbody>
        <s:iterator value="invoiceInfoList" status="status" var="b">
            <tr target="sid_order" rel="${orderCode }" align="center">
                ...
                <td><a href="javascript:;" onclick="if(window.console){console.log($(this).next('pre').html())}alert($(this).next('pre').html());">查看</a>
