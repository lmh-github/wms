    ...
    <div class="pageContent">
        <div class="pageFormContent" layoutH="97">
            <fieldset>
                ...
                <dl>
                    ...
                    <dd>
                        <select name="receive.receiveType">
                            <option value="101">
                                <s:property value="@com.gionee.wms.common.WmsConstants$ReceiveType@PURCHASE.name"/>
                            </option>
                            <option value="105">
                                <s:property value="@com.gionee.wms.common.WmsConstants$ReceiveType@PURCHARMA.name"/>
                            </option>
                            <option value="106">
                                <s:property value="@com.gionee.wms.common.WmsConstants$ReceiveType@SHUADAN.name"/>
                            </option>
                        </select>
                    </dd>
                </dl>
                <dl class="nowrap">
                    <dt>备注：</dt>
                    <dd><textarea name="receive.remark" style="width: 526px;height: 70px;resize: none;"></textarea></dd>
                </dl>
            </fieldset>
        </div>
        <div class="formBar">
