    ...
    <div class="pageContent">
        <div class="pageFormContent" layoutH="100">
            <fieldset>
                ...
                <dl>
                    <dt>开始日期：</dt>
                    <dd><input type="text" name="startTime" class="date" size="15" dateFmt="yyyy-MM-dd HH:mm:ss" value="<fmt:formatDate value="${activity.startTime }" pattern="yyyy-MM-dd HH:mm:ss"/>"/></dd>
                </dl>
                <dl>
                    <dt>结束日期：</dt>
