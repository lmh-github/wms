...
public class SalesOrder {
    ...
    public String getFullAddress() {
        return StringUtils.handleNullString(this.province) + StringUtils.handleNullString(this.city) + StringUtils.handleNullString(this.district) + StringUtils.handleNullString(this.address);
    }
