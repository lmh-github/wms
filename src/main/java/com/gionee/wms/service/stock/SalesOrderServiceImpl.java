...
import com.gionee.wms.common.WmsConstants.OutOrderTypeEnum;
...
import com.sf.integration.warehouse.request.WmsSailOrderRequest;
import com.sf.integration.warehouse.request.WmsSailOrderRequestHeader;
import com.sf.integration.warehouse.request.WwmsSailOrderRequestItem;
...
import com.sf.integration.warehouse.response.WmsSailOrderResponse;
...
public class SalesOrderServiceImpl implements SalesOrderService {
	...
	private ServiceCtrlMessage pushToSF(SalesOrder order, List<SalesOrderGoods> orderGoodsList) {
		try {
			...
			header.setWarehouse(WmsConstants.SF_WAREHOUSE); // 仓库
			...
			header.setMonthly_account(WmsConstants.SF_MONTHLY_ACCOUNT); // 月结账号
