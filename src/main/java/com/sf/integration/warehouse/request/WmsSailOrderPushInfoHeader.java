...
public class WmsSailOrderPushInfoHeader {
	...
	public String toString() {
		return "WmsSailOrderPushInfoHeader [company=" + company + ", warehouse=" + warehouse + ", erp_order=" + erp_order + ", shipment_id=" + shipment_id + ", waybill_no=" + waybill_no + ", actual_ship_date_time=" + actual_ship_date_time + ", carrier=" + carrier + ", carrier_service="
				+ carrier_service + ", user_stamp=" + user_stamp + ", status_time=" + status_time + ", status_code=" + status_code + ", status_remark=" + status_remark + "]";
	}
