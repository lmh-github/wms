 ...
 * <p>Title: Time  </p>
 * <p>Description: </p>
 *      <p>此类主要用来取得本地系统的系统时间并用下面5种格式显示<br>
 *              1.　YYMMDDHH         8位<br>
 *              2.　YYMMDDHHmm       10位<br>
 *              3.　YYMMDDHHmmss     12位<br>
 *              4.　YYYYMMDDHHmmss   14位<br>
 *              5.　YYMMDDHHmmssxxx  15位 (最后的xxx 是毫秒)</p>
...
public class DateConvert {
    ...
    */
    ...
    static public java.util.Date getNextTime(String timeStr) {
        ...
        if(0>scanHourOfDay || 0>scanMinute || 23<scanHourOfDay || 60<scanMinute || (23==scanHourOfDay&&59<scanMinute))  {
            return null ;
        }
    ...
    /**
     * 把字符串代表的日期转换为Date类型。
     * @param text yyyy-MM-dd HH:mm:ss格式的日期字符串。
     * @return
     */
  ...
  static public String convertD2String(Date date ,int length) {
      ...
      DateFormat formatter = new SimpleDateFormat(pattern.substring(0 ,length)) ;
      return formatter.format(date) ;
  }
  ...
  static public void main(String[] args) {
      java.sql.Timestamp timestamp0 = DateConvert.getTimestamp("2006-10-01 12:00" ,"yyyy-MM-dd HH:mm") ;
      System.out.println("timestamp0;" + timestamp0);
      System.out.println("timestamp0;" + DateConvert.getTime(DateConvert.YYYY_MM_DD));
  }
